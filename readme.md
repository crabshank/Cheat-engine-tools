...
N.B. When not in a trace: When a breakpoint is hit, the extension will make the main memory view's hex view jump to the last (or first if jmpFirst==true) memory address ('[…]') in the broken opcode.
